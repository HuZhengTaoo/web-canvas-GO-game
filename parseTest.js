...
var sgf = "(;CA[gb2312]AB[be][ae][ad][ab][cb][ca][fa][fc][gc][gd][ge][ff][fg][df][cg]AW[ba][bb][bc][ac][bd][dc][ec][fd][fe][ee][de]AP[MultiGo:4.4.4]SZ[19]AB[ce]MULTIGOGM[1](;B[cc];W[cd];B[dd];W[ed](;B[da])(;B[ea]C[1];W[da];B[db];W[eb])(;B[eb]C[1];W[db])(;B[db]C[1];W[eb]))(;B[dd]C[1];W[cc])(;B[cd]C[1];W[cc]))"
...
function traverse(node, nodeRef, wrong){
    ...
    if(children && children.length){
        ...
        for(var i in children){
            ...
            if(child instanceof SgfMoveNode){
                
                var name = markers[child.col] + (child.row + 1);
                ...
                if(child.isLastNode()){
                    ...
                    traverse(child, obj, wrong)
                }
                nodeRef.children.push(obj);
            }
        }
    }
}
traverse(sgfTree.current, myTree, false);
// console.log(sgfTree)